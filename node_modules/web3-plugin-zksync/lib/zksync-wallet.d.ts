...
declare class Adapters extends AdapterL1 {
    ...
    getL2BridgeContracts(): Promise<{
        erc20: import("web3-eth-contract").default<typeof import("./contracts/IL2Bridge").IL2BridgeABI>;
        weth: import("web3-eth-contract").default<typeof import("./contracts/IL2Bridge").IL2BridgeABI>;
        shared: import("web3-eth-contract").default<typeof import("./contracts/IL2Bridge").IL2BridgeABI>;
    }>;
