...
function decodeSignedTransaction(encodedSignedTransaction, returnFormat, options = { fillInputAndData: false }) {
    return {
        ...
        tx: (0, format_transaction_js_1.formatTransaction)({
            ...web3_eth_accounts_1.TransactionFactory.fromSerializedData((0, web3_utils_1.hexToBytes)(encodedSignedTransaction)).toJSON(),
        ...
        }, returnFormat, { fillInputAndData: options.fillInputAndData }),
    };
}
