...
class Web3ZKsyncL2 extends web3zksync_1.Web3ZkSync {
    ...
    async getWithdrawTx(transaction) {
        ...
        tx.amount = (0, web3_utils_1.format)({ format: 'uint' }, transaction.amount, web3_types_1.ETH_DATA_FORMAT);
    ...
    async getTransferTx(transaction) {
        var _a;
        const { ...tx } = transaction;
        tx.amount = (0, web3_utils_1.format)({ format: 'uint' }, tx.amount, web3_types_1.ETH_DATA_FORMAT);
        const isEthBasedChain = await this.isEthBasedChain();
