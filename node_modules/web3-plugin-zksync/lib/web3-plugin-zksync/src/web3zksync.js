...
class Web3ZkSync extends Web3.Web3 {
    ...
    async populateTransactionAndGasPrice(transaction) {
        ...
        const formatted = web3Utils.format(web3_eth_1.transactionSchema, populated);
        ...
        formatted.gasLimit =
            formatted.gasLimit ??
                (await (0, web3_eth_1.estimateGas)(this, formatted, 'latest', web3_1.DEFAULT_RETURN_FORMAT));
    ...
    async populateTransaction(transaction) {
        ...
        if (transaction.type && (0, web3_utils_1.toHex)(transaction.type) === (0, web3_utils_1.toHex)(constants_1.EIP712_TX_TYPE)) {
            delete transaction.type;
        }
        const populated = (await this.populateTransactionAndGasPrice(transaction));
        populated.type = BigInt(constants_1.EIP712_TX_TYPE);
