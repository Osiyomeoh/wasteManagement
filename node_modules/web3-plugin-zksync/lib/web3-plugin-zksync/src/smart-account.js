...
class SmartAccount extends adapters_1.AdapterL2 {
    ...
    async populateTransaction(tx) {
        return this.transactionBuilder(tx, this.secret, this.provider);
    }
    ...
    signMessage(message) {
        const signature = (0, web3_eth_accounts_1.signMessageWithPrivateKey)((0, utils_1.hashMessage)(message), this.secret);
