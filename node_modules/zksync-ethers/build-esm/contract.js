...
import { CONTRACT_DEPLOYER, CONTRACT_DEPLOYER_ADDRESS, DEFAULT_GAS_PER_PUBDATA_LIMIT, EIP712_TX_TYPE, getDeployedContracts, hashBytecode, } from './utils';
...
export class ContractFactory extends ethers.ContractFactory {
    ...
    async getDeployTransaction(...args) {
        ...
        if (this.interface.deploy.inputs.length + 1 === args.length) {
            ...
            (_a = overrides.customData).salt ?? (_a.salt = ethers.ZeroHash);
        ...
        (_c = tx.customData).gasPerPubdata ?? (_c.gasPerPubdata = DEFAULT_GAS_PER_PUBDATA_LIMIT);
