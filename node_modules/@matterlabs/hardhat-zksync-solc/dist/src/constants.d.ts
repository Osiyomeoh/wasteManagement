...
export declare const COMPILER_MIN_LINUX_VERSION_WITH_GNU_TOOLCHAIN = "1.5.3";
...
export declare const MISSING_LIBRARIES_NOTICE = "zksolc compiler detected missing libraries! For more details, visit: https://docs.zksync.io/build/tooling/hardhat/compiling-libraries.";
...
export declare const MISSING_LIBRARY_LINK = "For more details on how to use deploy-zksync:libraries task from hardhat-zksync-deploy plugin, visit: https://docs.zksync.io/build/tooling/hardhat/hardhat-zksync-deploy.";
