...
(0, config_env_1.extendEnvironment)((hre) => {
    hre.zkUpgrades = (0, plugins_1.lazyObject)(() => {
        ...
        return {
            deployProxy: (0, utils_1.checkOpenzeppelinVersions)(makeDeployProxy(hre)),
            upgradeProxy: (0, utils_1.checkOpenzeppelinVersions)(makeUpgradeProxy(hre)),
            validateImplementation: (0, utils_1.checkOpenzeppelinVersions)(makeValidateImplementation(hre)),
            deployBeacon: (0, utils_1.checkOpenzeppelinVersions)(makeDeployBeacon(hre)),
            deployBeaconProxy: (0, utils_1.checkOpenzeppelinVersions)(makeDeployBeaconProxy(hre)),
            upgradeBeacon: (0, utils_1.checkOpenzeppelinVersions)(makeUpgradeBeacon(hre)),
            deployProxyAdmin: (0, utils_1.checkOpenzeppelinVersions)(makeDeployProxyAdmin(hre)),
            admin: {
                getInstance: (0, utils_1.checkOpenzeppelinVersions)(makeGetInstanceFunction(hre)),
                changeProxyAdmin: (0, utils_1.checkOpenzeppelinVersions)(makeChangeProxyAdmin(hre)),
                transferProxyAdminOwnership: (0, utils_1.checkOpenzeppelinVersions)(makeTransferProxyAdminOwnership(hre)),
            },
            estimation: {
                estimateGasProxy: (0, utils_1.checkOpenzeppelinVersions)(makeEstimateGasProxy(hre)),
                estimateGasBeacon: (0, utils_1.checkOpenzeppelinVersions)(makeEstimateGasBeacon(hre)),
                estimateGasBeaconProxy: (0, utils_1.checkOpenzeppelinVersions)(makeEstimateGasBeaconProxy(hre)),
            },
        };
    });
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_GET_SOURCE_NAMES, async (args, _, runSuper) => {
    ...
    const upgradableContracts = (0, utils_1.getUpgradableContracts)();
    return [
        ...sourceNames,
        ...[
