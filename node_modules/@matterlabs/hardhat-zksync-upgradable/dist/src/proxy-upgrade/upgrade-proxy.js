...
function makeUpgradeProxy(hre) {
    ...
    async function getUpgrader(proxyAddress, wallet) {
        ...
        if ((0, upgrades_core_1.isEmptySlot)(adminAddress) || adminBytecode === '0x') {
            const TUPPath = (await hre.artifacts.getArtifactPaths()).find((x) => x.includes(path_1.default.sep + (0, utils_1.getUpgradableContracts)().TransparentUpgradeableProxy + path_1.default.sep + constants_1.ITUP_JSON));
