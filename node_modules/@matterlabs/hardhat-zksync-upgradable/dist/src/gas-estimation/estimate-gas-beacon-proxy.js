...
function makeEstimateGasBeaconProxy(hre) {
    return async function estimateGasBeaconProxy(deployer, args = [], opts = {}, quiet = false) {
        ...
        const beaconProxyPath = (await hre.artifacts.getArtifactPaths()).find((artifactPath) => artifactPath.includes(path_1.default.sep + (0, utils_1.getUpgradableContracts)().BeaconProxy + path_1.default.sep + constants_1.BEACON_PROXY_JSON));
