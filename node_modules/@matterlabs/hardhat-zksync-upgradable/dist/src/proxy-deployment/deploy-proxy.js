...
function makeDeployProxy(hre) {
    return async function deployProxy(wallet, artifact, args = [], opts = {}, quiet = false) {
        ...
        switch (kind) {
            ...
            case 'uups': {
                const ERC1967ProxyPath = (await hre.artifacts.getArtifactPaths()).find((x) => x.includes(path_1.default.sep + (0, utils_1.getUpgradableContracts)().ERC1967Proxy + path_1.default.sep + constants_1.ERC1967_PROXY_JSON));
            ...
            case 'transparent': {
                ...
                const TUPPath = (await hre.artifacts.getArtifactPaths()).find((x) => x.includes(path_1.default.sep + (0, utils_1.getUpgradableContracts)().TransparentUpgradeableProxy + path_1.default.sep + constants_1.TUP_JSON));
